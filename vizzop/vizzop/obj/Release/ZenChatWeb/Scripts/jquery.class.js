// jQuery Object Oriented zs_Class
//
// Version 1.0.2
//
...
jQuery.extend(jQuery.zs_Class, {
    ...
    getFunctionBody: function (func) {
        ...
        // Strip comments
        return jQuery.trim(m.replace(/^\s*\/\/.*$/mg, ''));
    },
    Function: function () { }
});

// define Function body
jQuery.extend(jQuery.zs_Class.Function, {
    Empty: function () { }
});
...
jQuery.extend(jQuery.zs_Class, {
    ...
    create: function () {
        ...
        jQuery.extend(handle.prototype, jQuery.zs_Class);
        ...
        if (parent) {
            ...
            for (property in parent.prototype) {
                if (property != 'superClass') {
                    switch (jQuery.type(parent.prototype[property])) {
                        case 'function':
            ...
            //jQuery.zs_Class.extend('superClass', true, handle.prototype, parent.prototype);
            // save parent
