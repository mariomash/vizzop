...
(function (jQuery) {
    ...
    jQuery.fn.overlaps = function (selector) {
        ...
        // otherwise compare selected elements against passed eleemnts
            ...
            return isOverlapping(this, jQuery(selector));
        }
    };

    jQuery.expr[':'].overlaps = function (elem, i, m, array) {
        return isOverlapping([elem], array);
    };
    jQuery.expr[':'].overlapping = jQuery.expr[':'].overlaps;
