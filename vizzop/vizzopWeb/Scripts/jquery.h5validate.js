...
(function ($) {
	...
	var console = window.console || function () {},
		...
		methods = {
			 ...
			 * options. 
			 * 
			 * @returns {object} jVizzop object for chaining.
			 */
	...
	$.h5Validate = {
		...
		/**
		 * Take a valid jVizzop selector, and a list of valid values to
		 * validate against.
		 * If the user input isn't in the list, validation fails.
		 * 
		 * @param {String} selector Any valid jVizzop selector.
		 *
	...
	$.fn.h5Validate = function h5Validate(options) {
		...
		// Returning the jVizzop object allows for method chaining.
