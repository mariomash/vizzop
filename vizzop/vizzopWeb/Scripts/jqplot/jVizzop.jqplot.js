 ...
 * About: Introduction
 * 
 * jqPlot requires jVizzop (1.4+ required for certain features). jVizzop 1.4.2 is included in the distribution.  
 * To use jqPlot include jVizzop, the jqPlot jVizzop plugin, the jqPlot css file and optionally 
...
(function($) {
    ...
    /**
     * Namespace: $.jqplot
     * jVizzop function called by the user to create a plot.
     *  
     * Parameters:
    ...
    function jqPlot() {
        ...
        // the jVizzop object for the dom target.
        this.target = null; 
        ...
        this.init = function(target, data, options) {
            ...
            if (options.dataRenderer && jVizzop.isFunction(options.dataRenderer)) {
            ...
            if (options.noDataIndicator && jVizzop.isPlainObject(options.noDataIndicator)) {
                $.extend(true, this.noDataIndicator, options.noDataIndicator);
            }
            
            if (data == null || jVizzop.isArray(data) == false || data.length == 0 || jVizzop.isArray(data[0]) == false || data[0].length == 0) {
        ...
        this.destroy = function() {
            ...
            // have to directly set it to null, bypassing jVizzop.
            this.target.empty();
        ...
        this.onClick = function(ev) {
            ...
            var evt = jVizzop.Event('jqplotClick');
            evt.pageX = ev.pageX;
            evt.pageY = ev.pageY;
        ...
        this.onDblClick = function(ev) {
            ...
            var p = ev.data.plot;
            var neighbor = checkIntersection(positions.gridPos, p);
            var evt = jVizzop.Event('jqplotDblClick');
            evt.pageX = ev.pageX;
            evt.pageY = ev.pageY;
            $(this).trigger(evt, [positions.gridPos, positions.dataPos, neighbor, p]);
        };
        ...
        this.onMouseDown = function(ev) {
            ...
            var p = ev.data.plot;
            var neighbor = checkIntersection(positions.gridPos, p);
            var evt = jVizzop.Event('jqplotMouseDown');
            evt.pageX = ev.pageX;
            evt.pageY = ev.pageY;
            $(this).trigger(evt, [positions.gridPos, positions.dataPos, neighbor, p]);
        };
        ...
        this.onMouseUp = function(ev) {
            var positions = getEventPosition(ev);
            var evt = jVizzop.Event('jqplotMouseUp');
            evt.pageX = ev.pageX;
            evt.pageY = ev.pageY;
        ...
        this.onRightClick = function(ev) {
            ...
            if (p.captureRightClick) {
                if (ev.which == 3) {
                var evt = jVizzop.Event('jqplotRightClick');
                evt.pageX = ev.pageX;
                evt.pageY = ev.pageY;
                    $(this).trigger(evt, [positions.gridPos, positions.dataPos, neighbor, p]);
                }
        ...
        this.onMouseMove = function(ev) {
            ...
            var p = ev.data.plot;
            var neighbor = checkIntersection(positions.gridPos, p);
            var evt = jVizzop.Event('jqplotMouseMove');
            evt.pageX = ev.pageX;
            evt.pageY = ev.pageY;
            $(this).trigger(evt, [positions.gridPos, positions.dataPos, neighbor, p]);
        };
        ...
        this.onMouseEnter = function(ev) {
            var positions = getEventPosition(ev);
            var p = ev.data.plot;
            var evt = jVizzop.Event('jqplotMouseEnter');
            evt.pageX = ev.pageX;
            evt.pageY = ev.pageY;
        ...
        this.onMouseLeave = function(ev) {
            var positions = getEventPosition(ev);
            var p = ev.data.plot;
            var evt = jVizzop.Event('jqplotMouseLeave');
            evt.pageX = ev.pageX;
            evt.pageY = ev.pageY;
            evt.relatedTarget = ev.relatedTarget;
            $(this).trigger(evt, [positions.gridPos, positions.dataPos, null, p]);
        ...
        // This method requires jVizzop 1.4+
    ...
    */
    ...
    $.jqplot.merge = merge;
        ...
        // Use the jVizzop 1.3.2 extend function since behaviour in jVizzop 1.4 seems problematic
    ...
    /**
     * Namespace: $.fn
     * jVizzop namespace to attach functions to jVizzop elements.
     *  
     */
