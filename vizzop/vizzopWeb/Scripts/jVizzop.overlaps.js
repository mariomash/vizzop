...
(function (jVizzop) {
    ...
    jVizzop.fn.overlaps = function (selector) {
        ...
        // otherwise compare selected elements against passed eleemnts
            ...
            return isOverlapping(this, jVizzop(selector));
        }
    };

    jVizzop.expr[':'].overlaps = function (elem, i, m, array) {
        return isOverlapping([elem], array);
    };
    jVizzop.expr[':'].overlapping = jVizzop.expr[':'].overlaps;
